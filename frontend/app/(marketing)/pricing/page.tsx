    ...
    <main className="min-h-screen bg-[#F8F1E7]">
      <section>
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:px-8 lg:py-16">
          <div className="rounded-[28px] border border-[#E3D2BC] bg-[#FFFDF8] p-5 shadow-[0_14px_40px_rgba(89,63,38,0.07)] sm:p-7">
            <p className="text-sm font-semibold text-[#B96E45]">Pricing pilot UMKM</p>
            <h1 className="mt-4 text-4xl font-bold tracking-tight text-[#251F1A] sm:text-5xl">
              Paket sederhana untuk mulai jualan, mengelola stok, dan menjalankan kasir.
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-[#6F6256]">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                className="inline-flex h-12 items-center justify-center rounded-xl bg-[#251F1A] px-5 text-base font-semibold text-[#FFFDF8] transition hover:bg-[#16110E]"
                href="/register"
              >
                Mulai buat toko
              </Link>
              <Link
                className="inline-flex h-12 items-center justify-center rounded-xl border border-[#E3D2BC] bg-white px-5 text-base font-semibold text-[#251F1A] transition hover:bg-[#F1E7D8]"
                href="/stores"
              >
                Lihat toko publik
              </Link>
          ...
          <Card className="self-start border-[#E3D2BC] bg-[#FFFDF8]/90 shadow-[0_18px_50px_rgba(89,63,38,0.08)]">
            <CardHeader>
            ...
            <CardContent className="space-y-3 text-sm leading-6 text-neutral-600">
              ...
              <p className="rounded-2xl border border-[#E8D2AA] bg-[#FFF5DE] p-3 text-[#7A4D1D]">
      ...
      <section className="mx-auto space-y-8 px-4 py-10 sm:px-6 lg:max-w-6xl lg:px-8">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-[#251F1A]">Pilih paket sesuai tahap toko</h2>
      ...
      <section className="mx-auto space-y-6 px-4 pb-10 sm:px-6 lg:max-w-6xl lg:px-8">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-[#251F1A]">Perbandingan fitur</h2>
        ...
        <div className="overflow-hidden rounded-[28px] border border-[#E3D2BC] bg-[#FFFDF8] shadow-[0_14px_40px_rgba(89,63,38,0.07)]">
          <div className="overflow-x-auto">
            <table className="min-w-[760px] w-full text-left text-sm">
              <thead className="bg-[#F1E7D8] text-[#6F6256]">
                <tr>
              ...
              <tbody className="divide-y divide-[#E3D2BC] text-[#6F6256]">
                {featureRows.map(([feature, starter, growth, business]) => (
                  <tr key={feature}>
                    <td className="px-5 py-4 font-medium text-[#251F1A]">{feature}</td>
      ...
      <section className="mx-auto grid gap-6 px-4 pb-10 sm:px-6 lg:max-w-6xl lg:grid-cols-[minmax(0,1fr)_360px] lg:px-8">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold tracking-tight text-[#251F1A]">FAQ</h2>
        ...
        <Card className="self-start border-[#E3D2BC] bg-[#251F1A] text-[#FFFDF8]">
          <CardContent className="space-y-4">
            ...
            <p className="text-sm leading-6 text-[#E3D2BC]">
            ...
            <Link
              className="inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#FFFDF8] px-5 text-sm font-semibold text-[#251F1A] transition hover:bg-[#F1E7D8]"
              href="/register"
            >
...
function PlanCard({ plan }: { plan: Plan }) {
  return (
    <Card className={plan.badge ? "relative border-[#b98955] bg-[#FFFDF8] shadow-[0_18px_50px_rgba(89,63,38,0.12)]" : "border-[#E3D2BC] bg-[#FFFDF8] shadow-none"}>
      {plan.badge ? (
      ...
      <CardHeader className="pr-28">
        <p className="text-sm font-semibold text-[#B96E45]">{plan.name}</p>
      ...
      <CardContent className="space-y-5">
        ...
        {plan.highlight ? (
          <p className="rounded-2xl border border-[#E8D2AA] bg-[#FFF5DE] p-3 text-sm font-medium text-[#7A4D1D]">{plan.highlight}</p>
        ) : null}
          ...
          <ul className="mt-3 space-y-2 text-sm leading-6 text-neutral-600">
            {plan.benefits.map((item) => (
              <li key={item} className="flex gap-2">
                <span aria-hidden="true" className="text-[#B96E45]">
                  &#10003;
                </span>
                <span>{item}</span>
              </li>
        ...
        <Link
          className={
            plan.badge
              ? "inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#251F1A] px-4 text-sm font-semibold text-[#FFFDF8] transition hover:bg-[#16110E]"
              : "inline-flex h-11 w-full items-center justify-center rounded-xl border border-[#E3D2BC] bg-white px-4 text-sm font-semibold text-[#251F1A] transition hover:bg-[#F1E7D8]"
          }
          href={plan.ctaHref}
        >
          {plan.ctaLabel}
