    ...
    <main className="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
      <Card className="overflow-hidden rounded-[28px] border-[#E3D2BC] bg-[#FFFDF8] shadow-[0_14px_42px_rgba(89,63,38,0.09)]">
        <div className="bg-[#251F1A] p-5 text-[#FFFDF8] sm:p-6">
          ...
          <h1 className="mt-3 text-2xl font-bold tracking-tight sm:text-3xl">Pesanan berhasil dibuat</h1>
        ...
        <CardContent className="space-y-4 p-4">
          ...
          {grandTotal > 0 ? (
            <div className="flex items-center justify-between rounded-2xl border border-[#E3D2BC] p-3">
