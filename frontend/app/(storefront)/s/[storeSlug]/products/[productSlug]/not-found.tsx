  ...
  return (
    <main className="flex min-h-[70vh] items-center justify-center px-4">
      <section className="max-w-md rounded-3xl border border-neutral-200 bg-white p-8 text-center shadow-soft">
        ...
        <h1 className="mt-2 text-2xl font-bold text-neutral-950">Produk tidak ditemukan</h1>
        <p className="mt-3 text-sm leading-6 text-neutral-500">
          Produk ini mungkin sudah tidak aktif atau tidak tersedia untuk toko ini.
        </p>
        <Link
          href="/"
