...
export const createShipmentSchema = z.object({
  ...
  shippingCost: z.number().int("Ongkir harus berupa angka bulat.").min(0, "Ongkir tidak boleh negatif."),
  assignedToName: z.string().trim().max(120, "Nama petugas maksimal 120 karakter.").optional(),
  assignedToPhone: z.string().trim().max(32, "HP petugas maksimal 32 karakter.").optional(),
