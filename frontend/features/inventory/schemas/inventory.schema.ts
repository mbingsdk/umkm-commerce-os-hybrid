...
export const stockAdjustmentSchema = z.object({
  ...
  quantity: z.number().int("Jumlah harus berupa angka bulat.").positive("Jumlah wajib lebih dari 0."),
...
export const thresholdSchema = z.object({
  lowStockThreshold: z.number().int("Threshold harus berupa angka bulat.").min(0, "Threshold tidak boleh negatif.")
});
